...
export default class ImagesHandler {
  ...
  constructor(imgSrc: string, options: IHandlerOptions = {}) {
    this.imgSrc = imgSrc;
  ...
  downloadImg(imgName: string | null) {
  ...
  // 用指定dom绘制图片
  paintByElement(container: HTMLElement, options: IPaintOptions) {
